...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/_sitemap` | `/config` | `/src/MockContacts` | `/src/StyleConstants` | `/src/components/buttons/MainPageButton` | `/src/components/headers/MainHeader` | `/src/components/headers/RegularHeader` | `/src/components/inputs/InputArray` | `/src/components/inputs/InputInformacionPersonal` | `/src/components/inputs/InputRadioButton` | `/src/pages/Agenda` | `/src/pages/AppLoading` | `/src/pages/BotonEmergencia/Boton` | `/src/pages/BotonEmergencia/CreateButtonView` | `/src/pages/BotonEmergencia/MyButtonView` | `/src/pages/BotonEmergencia/ProtectorListCheck` | `/src/pages/CentrosSalud` | `/src/pages/Home/Home` | `/src/pages/Home/Home2` | `/src/pages/InformacionLegal` | `/src/pages/InformacionPersonal/InformacionPersonal` | `/src/pages/InformacionPersonal/InformacionPersonalEdit` | `/src/pages/Login-Signup/Button` | `/src/pages/Login-Signup/InformacionInicial` | `/src/pages/Login-Signup/InputLogin` | `/src/pages/Login-Signup/Login` | `/src/pages/Login-Signup/Signup` | `/src/pages/Main` | `/src/pages/Medinator` | `/src/pages/ProtegidosProtectores/AddProtector` | `/src/pages/ProtegidosProtectores/ProtectorRow` | `/src/pages/ProtegidosProtectores/ProtegidoRow` | `/src/pages/ProtegidosProtectores/ProtegidosProtectores` | `/src/pages/Supervivencia` | `/src/pages/Wiki`;
